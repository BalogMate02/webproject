...
$authorizedUser = [
    'Email' => 'admin@admin',
    'Jelszo' => 'minda', // Példa jelszó, valós alkalmazásban biztonságosabb megoldásokat kell használni
];
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if ($Email === $authorizedUser['Email'] && $kodoltjelszo === sha1($authorizedUser['Jelszo'])) {
        $_SESSION['Email'] = $authorizedUser['Email'];
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            if ($userdata['Jelszo'] == $kodoltjelszo) {
                ...
                function_alert("Nem megfelelő e-mail cím vagy jelszó!");
            }
        } else {
...
<body>
    ...
    <main class="container">
        <form action="logineloado.php" method="post">
            <div class="wrapper">
                <div class="title">
                    Bejelentkezés
                </div>
